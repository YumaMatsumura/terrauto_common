...
#ifndef TERRAUTO_TYPE_ADAPTER__PCL_TYPE_ADAPTER_HPP_
#define TERRAUTO_TYPE_ADAPTER__PCL_TYPE_ADAPTER_HPP_
...
struct rclcpp::TypeAdapter<std::shared_ptr<PCL_POINTCLOUD_TYPE>, sensor_msgs::msg::PointCloud2>
{
  ...
  {
    destination = std::make_shared<PCL_POINTCLOUD_TYPE>();
    pcl::fromROSMsg(source, *destination);
    destination->header.frame_id = source.header.frame_id;
  }
};

#endif  // TERRAUTO_TYPE_ADAPTER__PCL_TYPE_ADAPTER_HPP_
